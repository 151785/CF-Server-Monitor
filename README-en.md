...
- `2.8.6`: Added GitHub login support, WSS frontend subscription 250ms batch report, Add an SMTP notification channel, Add monthly traffic threshold alert, remove legacy database compatibility
